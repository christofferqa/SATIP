...
let cubic_constraint_to_string (incl_constraint: Cubic.incl_constraint): string =
...
let pp_cubic_constraint (incl_constraint: Cubic.incl_constraint) =
  printf "%s" (cubic_constraint_to_string incl_constraint)

let pp_cubic_instance (instance: Cubic.instance) =
