...
let rec replace_identifier_by_type_exp_var_in_type_exp_var (id: Ast.identifier) (id_replacement: T.type_exp_variable) (type_exp_var: T.type_exp_variable): T.type_exp_variable =
  match type_exp_var with
  | T.Alpha -> type_exp_var
  | T.Int -> type_exp_var
  | T.Identifier id' -> if id = id' then id_replacement else type_exp_var
  | T.Expression exp -> type_exp_var
  | T.Pointer type_exp_var -> T.Pointer (replace_identifier_by_type_exp_var_in_type_exp_var id id_replacement type_exp_var)
  | T.Function (type_exp_vars, type_exp_var') -> T.Function (replace_identifier_by_type_exp_var_in_type_exp_vars id id_replacement type_exp_vars,
                                                             replace_identifier_by_type_exp_var_in_type_exp_var  id id_replacement type_exp_var')
and

replace_identifier_by_type_exp_var_in_type_exp_vars (id: Ast.identifier) (id_replacement: T.type_exp_variable) (type_exp_vars: T.type_exp_variable list): (T.type_exp_variable list) =
  ...
  List.fold_right (fun (type_exp_var: T.type_exp_variable) (acc: T.type_exp_variable list) ->
    (replace_identifier_by_type_exp_var_in_type_exp_var id id_replacement type_exp_var) :: acc
  ) type_exp_vars []


let replace_identifier_by_type_exp_var (id: Ast.identifier) (id_replacement: T.type_exp_variable) (type_constraints: T.type_constraint list): T.type_constraint list =
  List.fold_right (fun ((type_exp_var1, type_exp_var2): T.type_constraint) (acc: T.type_constraint list) ->
    (replace_identifier_by_type_exp_var_in_type_exp_var id id_replacement type_exp_var1,
     replace_identifier_by_type_exp_var_in_type_exp_var id id_replacement type_exp_var2) :: acc
  ) type_constraints []
...
let handle_type_constraint ((type_exp_var1, type_exp_var2): T.type_constraint) (stack: T.type_constraint list) (substitutions: T.type_constraint list): (T.type_constraint list) * (T.type_constraint list) =
  if type_exp_var1 = type_exp_var2 then
    ...
    | Types.Identifier id1, _ ->
      (* Replace each occurence of exp1 with type_exp_var2, and add the popped type constraint to the substitutions: *)
      (replace_identifier_by_type_exp_var id1 type_exp_var2 stack,
       (type_exp_var1, type_exp_var2) :: replace_identifier_by_type_exp_var id1 type_exp_var2 substitutions)
    ...
    | _, Types.Identifier id2 ->
      (* Replace each occurence of exp2 with type_exp_var1, and add the popped type constraint to the substitutions: *)
      (replace_identifier_by_type_exp_var id2 type_exp_var1 stack,
       (type_exp_var1, type_exp_var2) :: replace_identifier_by_type_exp_var id2 type_exp_var1 substitutions)
