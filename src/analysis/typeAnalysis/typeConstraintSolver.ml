      ...
      (match type_exp_var with
       | T.Expression exp ->
         ...
         if (Ast.is_identical_identifiers exp exp') then
           ...
           type_exp_var'
       | _ -> type_exp_var')
    | T.Pointer type_exp_var' -> T.Pointer (subst_in_type_exp_var type_exp_var type_exp_var_replacement type_exp_var')
    | T.Function (type_exp_vars, type_exp_var') -> T.Function (subst_in_type_exp_vars type_exp_var type_exp_var_replacement type_exp_vars,
...
let rec unify_one ((type_exp_var1, type_exp_var2): T.type_constraint) (stack: T.type_constraint list) (substitutions: T.type_constraint list): (T.type_constraint list) * (T.type_constraint list) =
  ...
  *)
  if type_exp_var1 = type_exp_var2 then
    ...
    | T.Pointer type_exp_var1', T.Pointer type_exp_var2' ->
      (* Call recursively *)
      unify_one (type_exp_var1', type_exp_var2') stack substitutions
      
    | T.Function (type_exp_vars1, type_exp_var1'), T.Function (type_exp_vars2, type_exp_var2') ->
      let rec add_argument_constraints = (fun (type_exp_vars1: T.type_exp_variable list) (type_exp_vars2: T.type_exp_variable list) (acc: T.type_constraint list) ->
